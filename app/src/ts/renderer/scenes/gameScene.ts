import { Bird } from '@renderer/objects/bird';
import { Pipe } from '@renderer/objects/pipe';
...
export class GameScene extends Phaser.Scene {
  ...
  update(): void {
    if (!this.bird.getDead()) {
      ...
      this.bird.update();
      this.physics.overlap(this.bird, this.pipes.children.getArray(), this.hitPipe, null, this);
    } else {
      Phaser.Actions.Call(
  ...
  private addOnePipe(x: number, y: number, frame: number): void {
